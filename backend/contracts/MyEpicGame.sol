...
contract MyEpicGame is ERC721 {
    ...
    constructor(
        ...
        for (uint i = 0; i < characterNames.length; ++i) {
            ...
            console.log("Done initializing %s w/ HP %s and img %s", c.name, c.hp, c.imageURI);
        }
        _tokenIds.increment();
    }
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '", "description": "This is an NFT that lets people play in the Coherence NFT Game!", "image": "',
